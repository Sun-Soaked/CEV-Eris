...
#define AREA_FLAG_CONSECRATED	16//Area is protected by the Angels (cannot gain entropy & will resist the effects of blueout)
#define AREA_FLAG_NULLED 		32//Area is completely severed from the simulacrum(no teleporting, no psionics, no litanies, no entropy, etc.)
